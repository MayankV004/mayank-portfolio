    ...
    <section id="contact" className="py-24 md:py-40 bg-background relative overflow-hidden">
      <div className="container px-4 md:px-6 mx-auto max-w-7xl relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 bg-card/40 backdrop-blur-md p-8 md:p-12 rounded-3xl border border-border/50 relative shadow-sm h-full flex flex-col justify-center">
