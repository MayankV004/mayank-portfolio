...
const PROFILES = [
  {
    ...
    color: "group-hover:border-[#FFA116]/50",
    bg: "bg-[#FFA116]/10",
  },
  {
    ...
    color: "group-hover:border-[#2F8D46]/50",
    bg: "bg-[#2F8D46]/10",
  },
  {
    platform: "Codeforces",
    ...
    color: "group-hover:border-[#1F8ACB]/50",
    bg: "bg-white/5",
  }
];
          ...
          {PROFILES.map((profile, idx) => (
            ...
            >
              <a href={profile.link} className="block h-full group">
                <Card className={`bg-card/40 backdrop-blur-sm border-border/50 transition-all duration-300 h-full flex flex-col ${profile.color} hover:shadow-lg hover:-translate-y-1`}>
